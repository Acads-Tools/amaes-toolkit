...
test("Navbar Version Badge, Persistent Top-Right Update Notice, and Reinstall Refresh Lifecycle", () => {
    ...
    // 1. Version integrity
    assert.ok(script.includes('@version      1.8.2'), "Userscript header must specify v1.8.2");
    assert.ok(script.includes('const SCRIPT_VERSION = "v1.8.2";'), "Constant SCRIPT_VERSION must be v1.8.2");
...
test("Gemini AI: Welcome Modal, README documentation, and Website Presentation", () => {
    ...
    assert.ok(readme.includes("version-1.8.2-blue.svg"), "README badge must show v1.8.2");

    // 3. Website (index.html)
    assert.ok(indexHtml.includes("release-badge\">v1.8.2<"), "Website must display v1.8.2 badge");
