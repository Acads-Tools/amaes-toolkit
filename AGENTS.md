...
When staging, committing, or pushing changes in this repository (`Acads-Tools/amaes-toolkit`), `Acads-Tools/database`, or any connected repo:
...
- **Zero Personal Linkage**:
  - NEVER use personal names, personal email addresses, local system user accounts, or external usernames (e.g. `anonymous-contributor`, `local-user`, etc.).
